...
public class Page_2 extends Base{

	public static By xpath_1 = By.xpath("abc");
	public static By xpath_2 = By.xpath("abc");
	public static By xpath_3 = By.xpath("abc");
	...
	public static void verifyUploadFiles() {
